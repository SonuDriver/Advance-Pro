...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'https://safelink.ramgadiya.com/')
SHORTLINK_API = environ.get('SHORTLINK_API', '3b1084e460672eb2ba77d2076257eab799cb1e9a')
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'False')), False)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/newmoviegroups2024')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+iHP3Y4949HRkYjg9')
MSG_ALRT = environ.get('MSG_ALRT', 'Whats up bitch ?')
